...
const CategoryCard = (props) => {
    return <Box className="feature-card" sx={{ position: "relative", boxShadow: 3, borderRadius: "20px", background: `linear-gradient(to bottom right, ${props.color1}, ${props.color2})`, "&:hover": { transition: "0.5s", boxShadow: 10, opacity: 15 } }} onClick={() => {

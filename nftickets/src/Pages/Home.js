...
const Home = (props) => {
    const HomeContent = <div>
        <Box sx={{ width: "100%", height: "75vh", background: "linear-gradient(100.85deg, #6FD9E8 0%, #BA6FE8 100%)", textAlign: "left", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <Box sx={{ height: "300vh", background: "#424242", display: "flex", alignItems: "flex-start", justifyContent: "center" }}>
